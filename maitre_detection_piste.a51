...
;l'appui sur BP0 provoque(progressivement) la deceleration et le braquage des roues a droite la led s'eteint
dir     		    bit     P1.4   ; commande de direction
mot    			 bit     p1.5   ; commande du moteur
tir    			 bit     p3.5   ; commande du tir
ledmC  			 bit     p1.0   ; indique microC en marche (led allumee si p1.0 = 0)
...
vd1h			equ		0f8h		;(65536-1830)			
vd1l			equ		0dah		;
vdr1h			equ		0fdh		;(65536-670)
vdr1l			equ		62h
...
debut:
				...
				mov		tl1,#0E6h	; pour le demmarage. 
...
; validation des interruptions du timer 0
        		...
        		cpl		ledmC
        		mov		r6,#2			; increment pour la direction					;max=1.83 et 1.10
				...
				mov		th0,#0FFh	; pour lancement du timer 0 première fois
				mov		tl0,#0F0h	; pour lancement du timer 0 première fois
...
infh4:
				...
				mov		vd2l,#0dah	;07d0h=2000d										;1830d
				mov		vdr2h,#0c2h	;reste de l'impulsion 3c8ch=15500d        ;15670d
				mov		vdr2l,#0cah
